...
private:
  ...
  Eigen::MatrixXd Ri = Eigen::MatrixXd(6, 6);
...
public:
  OldMinimumJerk(double dt_, double mass_);
  ...
  Eigen::VectorXd compute_acc_roots(Eigen::Vector6d eq_param, double deltaT);
